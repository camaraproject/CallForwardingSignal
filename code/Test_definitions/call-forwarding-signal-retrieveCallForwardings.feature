Feature: CAMARA Call Forwarding Signal  API, v0.5.0-rc.1 - Operation retrieveCallForwardings
  ...
  Background: Common call-forwarding-signal setup
    Given the path "/call-forwarding-signal/v0.5rc1/retrieve-forwardings"
