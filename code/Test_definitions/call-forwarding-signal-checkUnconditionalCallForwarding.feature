Feature: CAMARA Call Forwarding Signal  API, vwip - Operation checkUnconditionalCallForwarding
  ...
  Background: Common call-forwarding-signal setup
    Given the path "/call-forwarding-signal/vwip/check-unconditional-forwarding"
